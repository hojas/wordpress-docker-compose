...
Description: Custom version of Custom Post Templates plugin modified to work with the MovieWP theme, plugins need not be removed for any reason otherwise the theme stops working. DO NOT UPDATE!
